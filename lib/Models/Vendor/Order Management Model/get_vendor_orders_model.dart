class GetVendorOrdersModel {
  GetVendorOrdersModel({
  ...
  factory GetVendorOrdersModel.fromJson(Map<String, dynamic> json){
...
class Datum {
  ...
  final num? total;
  final double? perQtyQrcodePrice;
  ...
  factory Datum.fromJson(Map<String, dynamic> json){
    return Datum(
      ...
      revisionCommissionAmount: json["revision_commission_amount"]?.toDouble(), // Convert to double
      ...
      perQtyQrcodePrice: json["per_qty_qrcode_price"]?.toDouble(), // Convert to double
      ...
      orderTotalAfterVendorPurchaseCommission: json["order_total_after_vendor_purchase_commission"]?.toDouble(), // Convert to double
