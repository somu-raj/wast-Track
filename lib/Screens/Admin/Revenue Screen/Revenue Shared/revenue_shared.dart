                  ...
                  Padding(
                    ...
                    child: Container(
                      ...
                      child: ScrollConfiguration(
                        behavior: MyBehavior(),
                        child:controller.getRevenueShareAllModel == null?Center(child: myShimmer()): ListView.builder(
                                                        ...
                                                        Flexible(
                                                          child: Column(
                                                            ...
                                                            children: [
                                                              ...
                                                              controller.getRevenueShareCountModel!.data!.weekly!.changePercentage == null ? Text("0 % compared to last week",style: TextStyle( fontSize: 11, fontFamily:
                                                              AppFont
                                                                  .poppinsMedium,color: AppColor
                                                                  .grey1),) :Text(
                                                                "${controller.getRevenueShareCountModel!.data?.weekly?.changePercentage}% compared to last week",
                                                                style: TextStyle(
                                                                    fontFamily:
                                                                    AppFont
                                                                        .poppinsMedium,
                                                                    fontSize: 11,
                                                                    color:controller.getRevenueShareCountModel!.data!.weekly!.changePercentage!<0 ? AppColor.redLight:AppColor.green) ,
                                                              ),
                                                            ],
                                                          ),
                                                        ),
                                                              ...
                                                              AppFont
                                                                ...
                                                                style: TextStyle(
                                                                    ...
                                                                    AppFont
                                                                        .poppinsMedium,
                                                                    fontSize: 11,
                                                                    color:controller.getRevenueShareCountModel!.data!.monthly!.changePercentage!<0 ? AppColor.redLight:AppColor.green) ,
                                                              ),
                                                            ],
                                                          ),
                                                        ),
                                                              ...
                                                              AppFont
                                                                ...
                                                                style: TextStyle(
                                                                    ...
                                                                    AppFont
                                                                        .poppinsMedium,
                                                                    fontSize: 11,
                                                                    color:controller.getRevenueShareCountModel!.data!.yearly!.changePercentage!<0 ? AppColor.redLight:AppColor.green) ,
                                                              ),
                                                            ],
                                                          ),
                                                        ),
