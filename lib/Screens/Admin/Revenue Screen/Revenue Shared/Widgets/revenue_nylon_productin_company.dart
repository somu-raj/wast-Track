...
class RevenueNylonProductionCompany extends StatefulWidget {
  const RevenueNylonProductionCompany({super.key});

  @override
  State<RevenueNylonProductionCompany> createState() =>
      _RevenueNylonProductionCompanyState();
}

class _RevenueNylonProductionCompanyState
    extends State<RevenueNylonProductionCompany> {
