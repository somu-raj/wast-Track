...
class _StateManagementAgencyState extends State<StateManagementAgency> {
  ...
  final stateGovernmentVisibilityController = Get.put(StateGovernmentAgencyController());
      ...
      builder: (controller)=>
        Scaffold(
          floatingActionButton: FloatingActionButton(
            ...
            onPressed: () {
              Navigator.pushReplacementNamed(
                context,
                AppScreen.stateGovernmentAgencyAddScreen,
              );
            },
          ...
          body: Padding(
            ...
            Center(child: Text("${controller.stateModel?.message}")):
            Column(
              children: [
                Card(
                  elevation: 1,
                            ...
                            GestureDetector(
                              onTap: () {
                                Navigator.pushNamed(context,
                                    AppScreen.stateGovernmentAgencyEditScreen).then((value) {controller.getStateGovernmentAgencyApi(context);});
                              },
                              child: Container(
                                        ...
                                        children: [
                                          ...
                                          Row(
                                            ...
                                            children: [
                                              ...
                                              GestureDetector(
                                                onTap: () {
                                                  controller.deleteStateGovernmentApi(controller.stateModel!.data!.id.toString()).then((value) {
                                                    controller.getStateGovernmentAgencyApi(context);
                                                  });
                                                  Navigator.pop(context);
                ...
                //               children: [
                //                 Visibility(
                //                   visible: stateGovernmentVisibilityController.isContainerVisible.isTrue,
                //                   child: Stack(
                ...
                //                         child: GestureDetector(
                //                           onTap: () {
                //                             stateGovernmentVisibilityController.ContainerVisible();
                //                           },
                //                           child: Container(
                //                             decoration: BoxDecoration(
                //                                 borderRadius:
                ...
                //                 ),
                //                 Visibility(
                //                   visible: stateGovernmentVisibilityController.isContainerVisible.isFalse,
                //                   child: Stack(
                //                     clipBehavior: Clip.none,
                //                     children: [
                //                       Container(
                ...
                //                         child: GestureDetector(
                //                           onTap: () {
                //                             stateGovernmentVisibilityController.ContainerHide();
                //                           },
                //                           child: Container(
                //                             decoration: BoxDecoration(
                //                                 borderRadius:
