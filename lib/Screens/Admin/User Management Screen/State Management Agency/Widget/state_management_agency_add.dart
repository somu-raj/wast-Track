...
class StateManagementAgencyAdd extends StatefulWidget {
  const StateManagementAgencyAdd({super.key});

  @override
  State<StateManagementAgencyAdd> createState() => _StateManagementAgencyAddState();
}

class _StateManagementAgencyAddState extends State<StateManagementAgencyAdd> {
                              ...
                              CustomButton(
                                ...
                                onPressed: () async {
                                  if(formKey.currentState!.validate()){
                                    controller.addStateGovernmentAgencyApi(emailController.text, passwordController.text, firstNameController.text, lastNameController.text, mobileController.text, context);
                                ...
                                backgroundColor:
                                    MaterialStateProperty.all<Color>(
                                        AppColor.green),
                                buttonText: "Add State Government Agency",
