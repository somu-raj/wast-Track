...
class _NylonProductionCompanyEditState
  ...
  Widget build(BuildContext context) {
    return GetBuilder(init: NylonProductionCompanyController(context: context),
                    ...
                    child: Column(
                      children: [
                        ...
                        CustomButton(
                          ...
                          onPressed: () async {
                            print("this is id ${controller.lastNameController.text}");
                            controller.updateNylonProductionCompanyApi(
                                ...
                                controller.nylonModel?.data?.id.toString()
                            );
                          },
                          width: AppSize.getWidth(context),
                          backgroundColor:
                              MaterialStateProperty.all<Color>(AppColor.green),
                          buttonText: "Update Nylon Company",
