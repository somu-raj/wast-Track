...
class WasteManagementAgencyEdit extends StatefulWidget {
  final GetWasteAgencyModel? wastModelNew;
  const WasteManagementAgencyEdit({super.key,this.wastModelNew});
                        ...
                        CustomButton(
                          ...
                          onPressed: () async {
                            ...
                            updateWasteAgencyApi(
                                ...
                                controller.wasteModel!.data!.id
                            );
                          },
                          width: AppSize.getWidth(context),
                          backgroundColor:
                          MaterialStateProperty.all<Color>(AppColor.green),
                          buttonText: "Update Waste Management",
