...
import 'package:waste_track/Models/User%20Management%20Model/Waste%20Management%20Agency/get_agency_model.dart';
...
class WasteManagementStaffEdit extends StatefulWidget {
  final GetWasteStaffModel? staffModel;
  final int? index;

   WasteManagementStaffEdit({super.key,this.staffModel,this.index});
...
class _WasteManagementStaffEditState extends State<WasteManagementStaffEdit> {
  ...
  void initState() {
    ...
    super.initState();
    firstNameController = TextEditingController(text: widget.staffModel?.data[widget.index!].firstName ?? '');
    lastNameController = TextEditingController(text: widget.staffModel?.data[widget.index!].lastName);
    emailController = TextEditingController(text: widget.staffModel?.data[widget.index!].email);
    mobileController = TextEditingController(text: widget.staffModel?.data[widget.index!].phoneNumber);
  }
                  ...
                  child: Column(
                    children: [
                      ...
                      CustomButton(
                        ...
                        onPressed: () async {
                        controller.updateWasteStaffApi(emailController.text, passwordController.text, firstNameController.text, lastNameController.text, mobileController.text,widget.staffModel?.data[widget.index!].id,widget.staffModel?.data[widget.index!].vendorId,context).then((value) {
