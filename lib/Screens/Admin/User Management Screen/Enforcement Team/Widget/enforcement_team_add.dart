...
class EnforcementTeamAdd extends StatefulWidget {
  const EnforcementTeamAdd({super.key});

  @override
  State<EnforcementTeamAdd> createState() => _EnforcementTeamAddState();
}

class _EnforcementTeamAddState extends State<EnforcementTeamAdd> {
                              ...
                              CustomButton(
                                ...
                                onPressed: () async {
                                  if(formKey.currentState!.validate()){
                                    controller.addEnforcementApi(emailController.text, passwordController.text, firstNameController.text, lastNameController.text, mobileController.text, context);
                                ...
                                backgroundColor:
                                    MaterialStateProperty.all<Color>(
                                        AppColor.green),
                                buttonText: "Add Enforcement Team",
