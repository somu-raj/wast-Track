...
class InvoiceDetails extends StatefulWidget {
  String? invoiceId;
   InvoiceDetails({super.key,this.invoiceId});
...
//   }
  ...
  Widget build(BuildContext context) {
    // String apiDateString = "${invoiceController?.getInvoiceDetailsModel?.data?.createdAt}";
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    GestureDetector(
                      onTap: () {
                      controller.generateOrderInvoiceApi(context,getInvoiceDetailsModel?.data?.id ?? "");
                        // showDialog(
                        //   context: context,
