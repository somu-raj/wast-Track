...
import 'Widget/state_gov_nylon_management_details.dart';
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return Column(children: [
                      ...
                      GestureDetector(
                        onTap: () {
                          Navigator.push(context, MaterialPageRoute(builder: (context)=>StateGovNylonManagementDetails(batchNumber: nylonList?.batchNumber,vendorId: nylonList?.vendorId,)));
                        },
                        child: Padding(
