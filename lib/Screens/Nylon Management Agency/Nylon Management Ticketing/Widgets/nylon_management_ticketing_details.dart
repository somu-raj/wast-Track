...
class NylonManagementTicketDetails extends StatefulWidget {
  const NylonManagementTicketDetails({super.key});

  @override
  State<NylonManagementTicketDetails> createState() => _NylonManagementTicketDetailsState();
}

class _NylonManagementTicketDetailsState extends State<NylonManagementTicketDetails> {
