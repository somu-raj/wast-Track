...
class NylonManagementDetails extends StatefulWidget {
  const NylonManagementDetails({super.key});

  @override
  State<NylonManagementDetails> createState() =>
      _NylonManagementDetailsState();
}

class _NylonManagementDetailsState
    extends State<NylonManagementDetails>
