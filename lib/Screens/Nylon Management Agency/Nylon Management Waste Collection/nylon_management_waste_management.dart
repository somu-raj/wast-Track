...
class NylonManagementWasteCollection extends StatefulWidget {
  const NylonManagementWasteCollection({super.key});

  @override
  State<NylonManagementWasteCollection> createState() =>
      _NylonManagementWasteCollectionState();
}

class _NylonManagementWasteCollectionState extends State<NylonManagementWasteCollection>
