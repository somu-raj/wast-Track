...
class EcoBlueSubAdminWasteCollection extends StatefulWidget {
  const EcoBlueSubAdminWasteCollection({super.key});

  @override
  State<EcoBlueSubAdminWasteCollection> createState() =>
      _EcoBlueSubAdminWasteCollectionState();
}

class _EcoBlueSubAdminWasteCollectionState extends State<EcoBlueSubAdminWasteCollection>
                                                ...
                                                child: Padding(
                                                  ...
                                                  child: Column(
                                                    children: [
                                                      ...
                                                      //       flex: 1,
                                                      //       child:  Text(
                                                      //         "${controller.getWasteCollectionListModel!.data[index].name}",
                                                      //         style: TextStyle(
                                                      //             color:
                                                      //                 AppColor.black,
                                                      //             fontSize: 12,
                                                          ...
                                                          Row(
                                                            ...
                                                            children: [
                                                              ...
                                                              Expanded(
                                                                flex: 1,
                                                                child:  Text(
                                                                  "${controller.getWasteVerifyCollectionListModel!.data[index].name}",
                                                                  style: TextStyle(
                                                                      color: AppColor
                                                                          .black,
                                                                      fontSize:
