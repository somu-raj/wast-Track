...
class EnfocementTeamTicketDetails extends StatefulWidget {
  const EnfocementTeamTicketDetails({super.key});

  @override
  State<EnfocementTeamTicketDetails> createState() => _EnfocementTeamTicketDetailsState();
}

class _EnfocementTeamTicketDetailsState extends State<EnfocementTeamTicketDetails> {
