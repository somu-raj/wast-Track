...
class EnforcementTeamWasteCollection extends StatefulWidget {
  const EnforcementTeamWasteCollection({super.key});

  @override
  State<EnforcementTeamWasteCollection> createState() =>
      _EnforcementTeamWasteCollectionState();
}

class _EnforcementTeamWasteCollectionState extends State<EnforcementTeamWasteCollection>
