...
class EcoBlueSubNylonManagementDetails extends StatefulWidget {
  final batchNumber,vendorId;
  const EcoBlueSubNylonManagementDetails({super.key,this.batchNumber,this.vendorId});

  @override
  State<EcoBlueSubNylonManagementDetails> createState() =>
      _EcoBlueSubNylonManagementDetailsState();
}

class _EcoBlueSubNylonManagementDetailsState extends State<EcoBlueSubNylonManagementDetails> {
