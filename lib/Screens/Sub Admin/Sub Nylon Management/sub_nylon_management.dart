...
import '../../Eco Blue Sub Admin/Eco Blue Sub Admin Nylon Management/Eco Blue Sub Admin Nylon Management Details/eco_blue_sub_admin_nylon_management_details.dart';
import 'Sub Nylon Management Details/sub_nylon_management_details.dart';
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return Column(children: [
                      ...
                      GestureDetector(
                        onTap: () {
                          Navigator.push(context, MaterialPageRoute(builder: (context)=>EcoBlueSubNylonManagementDetails(batchNumber: nylonList?.batchNumber,vendorId: nylonList?.vendorId,)));
                        },
                        child: Padding(
