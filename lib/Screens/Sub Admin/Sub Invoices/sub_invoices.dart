...
import 'Widget/sub_invoices_details.dart';
                ...
                child: ScrollConfiguration(
                  ...
                  Center(child: Text("No order invoice list found !!")): ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      var invoiceSubList = controller.invoiceModel?.data[index];
                        ...
                        children: [
                          Column(
                            children: [
                              ...
                              GestureDetector(
                                onTap: () {
                                  Navigator.push(context, MaterialPageRoute(builder: (context)=>SubInvoiceDetails(invoiceId: invoiceSubList.id,)));
                                  // Navigator.pushNamed(
                          ...
                          Positioned(
                            ...
                            child: Container(
                                ...
                                child: Text(
                                  '${invoiceSubList.paymentStatusText}',
                                  style: TextStyle(
