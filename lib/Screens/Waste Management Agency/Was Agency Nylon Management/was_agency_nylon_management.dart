...
import 'Widget/was_agency_nylon_man_details.dart';
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return Column(children: [
                      ...
                      GestureDetector(
                        onTap: () {
                          Navigator.push(context, MaterialPageRoute(builder: (context)=>WasAgencyNylonManagementDetails(batchNumber: nylonList?.batchNumber,vendorId: nylonList?.vendorId,)));
                        },
                        child: Padding(
